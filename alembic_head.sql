...
-- Running upgrade 20d7fa647c5e -> f73a466bb86a
...
CREATE TABLE playground_sessions (
    ...
    personalisation_id UUID NOT NULL, 
    user_id UUID NOT NULL, 
    sdk_key VARCHAR NOT NULL, 
    session_marker VARCHAR NOT NULL, 
...
CREATE UNIQUE INDEX ix_playground_sessions_id ON playground_sessions (id);

CREATE INDEX ix_playground_sessions_personalisation_id ON playground_sessions (personalisation_id);

CREATE UNIQUE INDEX ix_playground_sessions_pid ON playground_sessions (pid);

CREATE INDEX ix_playground_sessions_user_id ON playground_sessions (user_id);

UPDATE alembic_version SET version_num='f73a466bb86a' WHERE alembic_version.version_num = '20d7fa647c5e';
